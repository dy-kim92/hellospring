...
public class WelcomeController {
	...
	//	파라미터 기본 값 예제
	//	기본 방식으로 RequestParam 을 사용하면 반드시 파라미터가 전달되어야 한다
//	public ModelAndView home(@RequestParam String name) {
	...
	//	Path Variable
	//	파라미터를 URL 쿼리 스트링 (ex : ?name=____&no=____)으로 전달하지 않고
	//	URL 경로상에 지정하는 방법 (Fancy URL, Pretty URL)
	//		{} -> url 경로 상의 내용을 파라미터로 변환
	...
	//	Model을 사용해야 할 경우
	//	메소드 인자값으로 Model을 받아올 수 있다 -> 사용할 수 있다
	@RequestMapping("/rstr2")
	public String returnString2(ModelMap map) {
		//	필요할 때 필요한 객체를 메소드 인자로 요청하면
